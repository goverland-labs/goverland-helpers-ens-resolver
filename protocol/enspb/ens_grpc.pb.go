...
const (
	Ens_ResolveAddresses_FullMethodName  = "/enspb.Ens/ResolveAddresses"
	Ens_ResolveDomains_FullMethodName    = "/enspb.Ens/ResolveDomains"
	Ens_ResolveAllDomains_FullMethodName = "/enspb.Ens/ResolveAllDomains"
)
...
type EnsClient interface {
	...
	ResolveAllDomains(ctx context.Context, in *ResolveAllDomainsRequest, opts ...grpc.CallOption) (*ResolveAllDomainsResponse, error)
}
...
func (c *ensClient) ResolveAddresses(ctx context.Context, in *ResolveAddressesRequest, opts ...grpc.CallOption) (*ResolveResponse, error) {
	...
	err := c.cc.Invoke(ctx, Ens_ResolveAddresses_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ensClient) ResolveDomains(ctx context.Context, in *ResolveDomainsRequest, opts ...grpc.CallOption) (*ResolveResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResolveResponse)
	err := c.cc.Invoke(ctx, Ens_ResolveDomains_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ensClient) ResolveAllDomains(ctx context.Context, in *ResolveAllDomainsRequest, opts ...grpc.CallOption) (*ResolveAllDomainsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResolveAllDomainsResponse)
	err := c.cc.Invoke(ctx, Ens_ResolveAllDomains_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EnsServer interface {
	...
	ResolveAllDomains(context.Context, *ResolveAllDomainsRequest) (*ResolveAllDomainsResponse, error)
...
func (UnimplementedEnsServer) ResolveAllDomains(context.Context, *ResolveAllDomainsRequest) (*ResolveAllDomainsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResolveAllDomains not implemented")
}
...
func _Ens_ResolveAddresses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ens_ResolveAddresses_FullMethodName,
	}
...
func _Ens_ResolveDomains_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ens_ResolveDomains_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Ens_ResolveAllDomains_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResolveAllDomainsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EnsServer).ResolveAllDomains(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ens_ResolveAllDomains_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnsServer).ResolveAllDomains(ctx, req.(*ResolveAllDomainsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Ens_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ResolveAllDomains",
			Handler:    _Ens_ResolveAllDomains_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "enspb/ens.proto",
}
